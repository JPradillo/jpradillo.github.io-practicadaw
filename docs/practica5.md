...
![NGINX SSL Termination](image.png)
...
![Administrador de certificados](image-2.png)
...
![Advertencia: riesgo potencial de seguridad a continuación](image-3.png)
...
![/etc/nginx/sites-available](image-7.png)
...
![Información del sitio](image-8.png)

Con más información:

![Más información](image-9.png)
...
![Certificado](image-10.png)

Y podremos ver los detalles:

![Detalles](image-11.png)
...
![Configuración de "balanceo"](image-12.png)
